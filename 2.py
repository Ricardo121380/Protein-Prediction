...
# 示例：从仓库目录加载数据集，避免依赖个人电脑上的绝对路径
DATA_DIR = Path(__file__).resolve().parent
train_dataset = ProteinDataset(DATA_DIR / 'protein-secondary-structure.train.txt')
test_dataset = ProteinDataset(DATA_DIR / 'protein-secondary-structure.test.txt')
